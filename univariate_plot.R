...
##
## The graphs are created with ggplot2 and then assembled into
## a single plot through the patchwork package. Missing values
## are deleted.
##
## parameters:
## data: a data frame.
...
## density: logical. Plot a filled density curve over the
## the histogram. (default=TRUE)
## densitycolor: fill color for density curve.
## alpha: Alpha transparency (0-1) for the density curve and
## jittered points.
